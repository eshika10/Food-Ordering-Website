...
<title>Food Item List</title>
    ...
    <!-- Script Link -->
      ...
      <script>
          function placeFoodOrder(food_id,user_email){
        	  window.location.href='/placeFoodOrder?food_id='+encodeURIComponent(food_id)+'&user_email='+encodeURIComponent(user_email);
          }
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th style="text-align=center;">Place Order</th>
                    ...
                    <c:forEach var="product" items="${model_food_list}">
                        <tr>
                           ...
                           <td style="text-align: center;"> 
                                ...
                                <button class="btn btn-primary" onclick="placeFoodOrder('${product.getId()}','${model_user.getEmail()}')" style="text-align:center"> 
